...
public class Matrix
{
    ...
    public void write(java.io.File paramFile, HashSet<String> authorizedCells)
    {
        ...
        try
        {
          ...
          try { os.close(); } catch (Exception e2) { System.err.println("can not close stream"); } } finally { try { os.close(); } catch (Exception e3) { System.err.println("can not close stream");
        }
      }
