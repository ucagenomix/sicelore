...
@CommandLineProgramProperties(summary = "Remove read from INPUT", oneLineSummary = "Remove read from INPUT", programGroup = org.ipmc.sicelore.cmdline.SiCeLoReUtils.class)
@DocumentedFeature
