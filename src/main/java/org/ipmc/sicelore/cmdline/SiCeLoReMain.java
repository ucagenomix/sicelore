...
public class SiCeLoReMain extends PicardCommandLine
{
  ...
  protected static List<String> getPackageList() { List<String> packageList = new ArrayList();
    packageList.add("org.ipmc.sicelore");
    return packageList;
  }
   
  public static void main(String[] args) { System.exit(new SiCeLoReMain().instanceMain(args, getPackageList(), COMMAND_LINE_NAME)); }
}