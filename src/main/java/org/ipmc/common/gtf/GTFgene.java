...
public class GTFgene
{
   ...
   public String getGene_id(){ return this.gene_id; }
   public String getGene_name(){ return this.gene_name; }
   public String getChromosome(){ return this.chromosome; }
   public int getStart(){ return this.start; }
   public int getEnd(){ return this.end; }
   public String getStrand(){ return this.strand; }
   public int getNb_reads(){ return this.nb_reads; }
   
   public TreeMap<String, GTFjunction> getJunctions(){ return this.junctions; }
   public TreeMap<String, GTFexon> getExons(){ return this.exons; }

   public GTFtranscript getTranscript(String transcript_id) { return this.transcripts.get(transcript_id); }
   public void addTranscript(GTFtranscript transcript) { this.transcripts.put(transcript.getTranscript_id(),transcript); }
