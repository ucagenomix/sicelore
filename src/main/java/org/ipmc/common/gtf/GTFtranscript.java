...
public class GTFtranscript
{
   ...
   public String getTranscript_id(){ return this.transcript_id; }
   public String getTranscript_name(){ return this.transcript_name; }
   public String getChromosome(){ return this.chromosome; }
   public int getStart(){ return this.start; }
   public int getEnd(){ return this.end; }
   public String getStrand(){ return this.strand; }

   public Vector getJunctions(){ return this.junctions; }
   public Vector getExons(){ return this.exons; }
