...
public class GTFparser
{
   ...
   public int getNb_genes(){ return this.nb_genes; }
   public int getNb_transcripts(){ return this.nb_transcripts; }
   public int getNb_exons(){ return this.nb_exons; }
   public int getNb_uniq_exons(){ return this.nb_uniq_exons; }
   public int getNb_uniq_junctions(){ return this.nb_uniq_junctions; }
