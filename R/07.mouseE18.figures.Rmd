...
# Percentage of Illumina UMIs / Genes seen in Nanopore (1141 cells)

```{r message=FALSE, warning=FALSE, echo=FALSE, eval=T, fig.height=4, fig.width=6}

100*sum(s1141@meta.data$nCount_ISOG)/sum(s1141@meta.data$nCount_RNA)
100*sum(s1141@meta.data$nFeature_ISOG)/sum(s1141@meta.data$nFeature_RNA)
