...
illu1141 <- FindClusters(object = illu1141, resolution=1)

illu1141 <- readRDS("1141c.label.rds")
illu1141 <- FindNeighbors(object = illu1141, do.plot=TRUE, dims = 1:11)
...
write.table(illu1141.markers, file="illu1141.markers.csv", sep=",")
...
new.cluster.ids <- c("GABAergic","Glutamatergic imature 3","Glutamatergic","GABAergic imature","Glutamatergic", "RPs proliferative","Glutamatergic progenitors","Glutamatergic imature 4","Radial glia","Cajal-Retzius")
names(x = new.cluster.ids) <- levels(x = illu1141)
illu1141 <- RenameIdents(object = illu1141, new.cluster.ids)

my_levels <- c("Radial glia", "RPs proliferative","Glutamatergic progenitors", "Glutamatergic imature 4", "Glutamatergic imature 3", "Glutamatergic","GABAergic imature","GABAergic","Cajal-Retzius")
...
#write.table(illu1141.markers, file="output/isoforms.csv", sep=",")

illu1141.markers$geneId <- sapply(strsplit(illu1141.markers$gene, "-ENS"), `[`, 1)
illu1141.markers$transcriptId <- paste("ENS", sapply(strsplit(illu1141.markers$gene, "-ENS"), `[`, 2), sep="")
...
write.table(illu1141.markers, file="output/isoforms.DE.csv", sep=",")
