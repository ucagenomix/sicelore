...
FeaturePlot(object = illu1141, features = c("Myl6"), cols=c("grey","red"), reduction="tsne", pt.size=2, min.cutoff = 0)
FeaturePlot(object = illu1141, features = c("Myl6"), cols=c("grey","blue"), reduction="tsne", pt.size=2, min.cutoff = 0)
dev.off()
