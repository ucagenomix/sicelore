...
$java -jar -Xmx4g Jar/Sicelore-2.0.jar AddBamReadSequenceTag I=$output_dir/GE.bam O=$output_dir/GEUS.bam FASTQDIR=$output_dir/passed/ VALIDATION_STRINGENCY=SILENT
